...
const CancelEventPage = () => {
  ...
  return (
    <div className='pt-10'>
      ...
      <DataTable columns={cancelEventColumns} onRowClick="/admin/cancelrequests" isNoDeleteButton={true} permissionAllowedFunction={handleCancelEvent} isSrno={true} data={cancelEventData?.data || []} isPermissionActions={true} messageForNoRecord='No Events Found!' />
    </div>
  )
}
